...
<!-- 본문 DATA 끝 -->
<style>
.ui-th-ltr, .ui-jqgrid .ui-jqgrid-htable th.ui-th-ltr{    padding: 3px 6px;}
.ui-jqgrid tr.jqgrow td{padding:3px 6px !important;}
.ui-jqgrid tr.jqgrow td:nth-last-child(2){text-align: center;}
.ui-jqgrid .ui-jqgrid-htable th#dataGrid_flagType{padding:0;}
@media (max-width: 1590px) {
.ui-th-ltr, .ui-jqgrid .ui-jqgrid-htable th.ui-th-ltr{    padding: 0;}
.ui-jqgrid tr.jqgrow td{padding:0 !important;}
}
</style>
</form:form>
</BODY>

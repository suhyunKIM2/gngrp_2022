				...
				<tr>
					...
					<td valign="bottom" width="*" align="right"> 
						<table border="0" cellspacing="0" cellpadding="0" height="17">
							<tr> 
								<td valign="top" class="SubLocation"></td>
...
<div id="ActionButton">
<!-- 수행버튼 시작 -->
<table width="100%" cellspacing="0" cellpadding="0" border="0" id=btntbl name="btntbl">
	<tr>
		<td><span id="flagText"></span></td>
		<td align="right"> 
			<a onclick="javascript:ApprOpinion('<%= sApprId %>');" class="button white medium">
			<img src="../common/images/bb02.gif" border="0"> <spring:message code="appr.appr.comment" text="결재의견 보기"/> </a>
...
%>
	...
	<%}else if(sFormID.equals(ApprDocCode.APPR_FIX_NUM_42)||(apprreadInfo.getApprFormid().equals(ApprDocCode.APPR_FIX_NUM_42))){//계약 확정 기안 %>
	...
	<%}else if(sFormID.equals(ApprDocCode.APPR_FIX_NUM_44)||(apprreadInfo.getApprFormid().equals(ApprDocCode.APPR_FIX_NUM_44))){//연장근로신청서 %>
...
<!-- 결재의견 삽입 끝-->
<div id="dispContent" style="display:nones;">${content}</div>
